...
const CLOUDS = [
  { x: 14, y: 22, size: 54, alpha: 0.55 },
  { x: 78, y: 17, size: 44, alpha: 0.45 },
  { x: 62, y: 54, size: 64, alpha: 0.35 },
  { x: 22, y: 71, size: 56, alpha: 0.4 },
  { x: 88, y: 62, size: 40, alpha: 0.38 },
];

const AMBIENT_ORBS = [
  { x: 18, y: 30, size: 72, alpha: 0.16 },
  { x: 84, y: 70, size: 86, alpha: 0.13 },
  { x: 66, y: 22, size: 46, alpha: 0.18 },
  { x: 30, y: 78, size: 54, alpha: 0.15 },
  { x: 52, y: 52, size: 30, alpha: 0.2 },
  { x: 6, y: 60, size: 26, alpha: 0.16 },
];

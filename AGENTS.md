...
| Search trigger / modal / fuzzy index              | `src/components/SearchTrigger.tsx` + `src/components/SearchModal.tsx` + `src/styles/search.css`; runtime util `src/utils/search.ts` (Fuse.js); index baked by `scripts/generate-search-index.mjs` into gitignored `src/data/search-index.json` (schema `schemas/search-index.schema.json`)                                                                                                                         |
